...
if __name__ == '__main__':
    ...
    for i in range(0, 501, 50):
        ...
        warp_auc.append(
            auc_score(warp_model, test, train_interactions=train, item_features=item_f, user_features=user_f).mean())
        warp_auc1.append(auc_score(warp_model, train, item_features=item_f, user_features=user_f).mean())

        warp_prec.append(precision_at_k(warp_model, test, k=5, item_features=item_f, user_features=user_f,
